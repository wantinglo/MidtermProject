...
<body>
	...
	<table class="alldata">
		...
		<c:forEach var="anProduct" varStatus="stat" items="${type_items}">
			<form action="queryproductsingle.controller" method="post"
				...
				<tr class="${stat.count%2==0?'odd':'even'}">
					...
					<td><input type="button" class="btn btn-warning" name="delete"
						value="刪除" onclick="confirmDelete(${anProduct.p_id})"></td>
				</tr>
			</form>
		</c:forEach>
